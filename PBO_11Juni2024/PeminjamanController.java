...
public class PeminjamanController {
   private final FormPeminjaman form;
    private final List<Peminjaman> data;
    ...
    public void savePeminjaman() {
        try {
            ...
            String tglPinjam = form.getTxtTglPeminjaman().getText();
    ...
    public void getPeminjaman() {
        ...
        int selectedRow = form.getTblPeminjaman().getSelectedRow();
        if (selectedRow != -1) {
            Peminjaman peminjaman = data.get(selectedRow);
            form.getTxtKodeAnggota().setText(peminjaman.getKodeAnggota());
            form.getTxtKodeBuku().setText(peminjaman.getKodeBuku());
            form.getTxtTglPeminjaman().setText(peminjaman.getTglPinjam());
            form.getTxtTglKembali().setText(peminjaman.getTglKembali());
            form.getTxtTerlambat().setText(String.valueOf(peminjaman.getTerlambat()));
            form.getTxtDenda().setText(String.valueOf(peminjaman.getDendaTotal()));
        }
    } 
    ...
    public void calculateTerlambatAndDenda(){
        ...
        try {
            Date tglPinjam = sdf.parse(form.getTxtTglPeminjaman().getText());
